...
sensitivity = 1.0  # Adjust this value to control sensitivity
    ...
    if results.multi_face_landmarks:
        ...
        for id, landmark in enumerate(landmarks[474:478]):
            ...
            if id == 1:  # Use a specific landmark for mouse control
                # Calculate mouse coordinates with sensitivity factor
                mouse_x = int((screen_w / frame.shape[1] * x) * sensitivity)
                mouse_y = int((screen_h / frame.shape[0] * y) * sensitivity)
